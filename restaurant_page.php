...
// Fetch photos
$photos_sql = "SELECT url FROM photos WHERE restaurant_id = $restaurant_id";
...
// Default photo URL
$photo_url = "/w3images/hamburger.jpg";
if ($photos_result->num_rows > 0) {
    $photo = $photos_result->fetch_assoc();
    $photo_url = $photo['url'];
}
?>
<!DOCTYPE html>
...
.photo-item {
    overflow: hidden; /* Ensure photos do not exceed their containers */
    border-radius: 8px;
    box-shadow: 0 0 5px rgba(0, 0, 0, 0.1); /* Optional: add shadow for each photo */
}
...
<div class="container">
    ...
    <div class="photos">
        ...
        <div class="photo-grid">
            <?php
        // Loop through photos fetched from database
            while ($photo = $photos_result->fetch_assoc()) {
                echo '<div class="photo-item">';
                echo '<img src="' . htmlspecialchars($photo['url']) . '" alt="Restaurant Photo">';
                echo '</div>';
            }
            ?>
        </div>
